...
/*!
\brief
reflection matrix on YZ plane

*/
/******************************************************************************/

void Mtx44::SetToReflectionYZplane()
{
    SetToIdentity();
    a[0] = -1;
}
...
/*!
\brief
reflection matrix on XZ plane

*/
/******************************************************************************/
void Mtx44::SetToReflectionXZplane()
{
    SetToIdentity();
    a[5] = -1;
}
...
/*!
\brief
reflection matrix on XY plane

*/
/******************************************************************************/
void Mtx44::SetToReflectionXYplane()
{
    SetToIdentity();
    a[10] = -1;
}
...
/*!
\brief
shearing matrix on axis

*/
/******************************************************************************/
void Mtx44::SetToShearingXaxis(float x)
{
    SetToIdentity();
    a[4] = x;
}
